...
into a sharing graph and represent it as a collection of three tuple sets inorder to simplify our type inference algorithm.
  ...
  \begin{framed}
    \begin{flalign*}
      ...
      \text{Types}\ \ \               \tau            &::= t \mid \tau \rightarrow \tau\
                                \text{where}\ \{\overset{!}{\sepimp}, \sepimp, \xrightarrow{!}, \rightarrow \} \subseteq \rightarrow \\
