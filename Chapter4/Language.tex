  ...
  \begin{framed}
    \begin{flalign*}
      ...
      \text{Types}\ \ \               \tau            &::= t \mid \tau \rightarrow \tau\
                                \text{where}\ \{\tightoverset{\scalebox{0.5}{!}}{\sepimp}, \sepimp, \tightoverset{\scalebox{0.5}{!}}{\shimp}, \shimp \} \subseteq \rightarrow \\
...
\begin{figure}[h]\centering
  \begin{framed}
    ...
    \begin{minipage}{0.24\linewidth}
      \begin{prooftree}
        \AxiomC{$P => \Un{\tau}$}
        \UnaryInfC{$P => \tau \geq (v \tightoverset{\scalebox{0.5}{!}}{\sepimp} v')$}
      \end{prooftree}
    \end{minipage}%
    \begin{minipage}{0.24\linewidth}
      \begin{prooftree}
        \AxiomC{$P => \Un{\tau}$}
        \UnaryInfC{$P => \tau \geq (v \tightoverset{\scalebox{0.5}{!}}{\shimp} v')$}
      \end{prooftree}
    \end{minipage}
