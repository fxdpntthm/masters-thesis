...
of returning the type of the variable it returns the sharing information. Domain of $\Psi$ defined as $\texttt{dom}(\Psi) = \{x \mid (x, \bar{y}) \in \Psi \}$
...
operation is a reflexive, symmetric and transitive we observe certain properties given below.
