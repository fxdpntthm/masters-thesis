...
of resources of the fully concretized type. The reason to use multisets can now be explained
as the elimiation rule ([$\rightarrow$E]) can be expressed by simply duplicating the typing
judgements that are in sharing after we split the type assignment into two parts,
