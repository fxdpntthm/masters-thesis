...
% \item $\rightfilledspoon$ for separating function application
    ...
    \begin{minipage}{1\textwidth}
      \begin{prooftree}
        \AxiomC{$\Pi \mid \Gamma \vdash M : \phi \tau \tau' \ \ \ \ \
          ...
          \Pi \Rightarrow \texttt{ShFun} \phi \ \ \ \
          \Pi \vdash \Gamma \geq \phi$} \RightLabel{$[\rightfilledspoon E]$}
    ...
    \begin{minipage}{1\textwidth}
      \begin{prooftree}
        \AxiomC{$\Pi \mid \Gamma_{x},x: \tau \vdash M : \tau' \ \ \ \ \
          ...
          \Pi \vdash \Gamma \geq \phi$} \RightLabel{$[\rightfilledspoon I]$}
