  ...
  \begin{framed}
    \begin{minipage}{1\linewidth}
      \begin{prooftree}
        ...
        \BinaryInfC{$P \mid \Gamma;\Delta \vdash \Pair{M;N} : \tau \with \tau'$}
      \end{prooftree}
    \end{minipage}
    ...
    \begin{minipage}{1\linewidth}
      \begin{prooftree}
        ...
        \BinaryInfC{$P \mid \Gamma,\Delta \vdash \Pair{M,N}: \tau \otimes \tau'$}
      \end{prooftree}
    \end{minipage}
    ...
    \begin{minipage}{.5\linewidth}
      \begin{prooftree}
        ...
        \BinaryInfC{$P \mid \Gamma \vdash \texttt{fst}\ M: \tau$}
      \end{prooftree}
    \end{minipage}
    \begin{minipage}{.5\linewidth}
      \begin{prooftree}
        ...
        \AxiomC{$P => \texttt{Un}\ \tau$}
        \BinaryInfC{$P \mid \Gamma \vdash \texttt{snd}\ M: \tau'$}
      \end{prooftree}
    \end{minipage}
  \end{framed}
  \caption{Typing rules for Pairs}
...
\begin{minipage}{1\textwidth}
  \begin{prooftree}
    ...
    \TrinaryInfC{$P \mid \Delta \bullet \Delta' \vdash \Case{M}{\{\texttt{inl}\ x \mapsto N; \texttt{inr}\ x \mapsto N'\}} : v $}
  \end{prooftree}
\end{minipage}
% sum type I_l
\begin{minipage}{0.5\textwidth}
