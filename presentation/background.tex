...
\begin{frame}[c]
  ...
  \begin{center}
    \uncover<2->{\LARGE {\color{red}Propostions are truth values not resources}}\\
    \uncover<1->{{\small
        \fbox{Language}
        \begin{flalign*}
...
\begin{frame}[c]
  ...
  \begin{center}
    ...
    \end{itemize}
    \uncover<2->{\LARGE \color{red} Propostions now behave like resources}
  \end{center}
\end{frame}
...
\begin{frame}[c]
  ...
  \begin{center}
    \begin{itemize}
  \item Contexts are lists or sets
    $$ \Gamma, A, B $$
