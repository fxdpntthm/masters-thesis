...
\documentclass[12pt,english]{thesis/kuthesis}
\usepackage{mathptmx}
\usepackage{MnSymbol}
...
\include{thesis/Chapter1/Introduction}       % Extended abstract, contributions
\include{thesis/Chapter2/BackgroundWork}     % HM type system, algorithm M, linear logic, BI, qualified types, Quill
\include{thesis/Chapter3/Examples}           % file handles and exceptions
\include{thesis/Chapter4/Language}           % Core language syntax and Types, contexts and related definitions
\include{thesis/Chapter5/TypeSystem}         % typing rules, syntax directed typing rules and modified Algorithm M
\include{thesis/Chapter6/Datastructure}      % kinds with user defined datatypes. sharing pair, separating pair.
\include{thesis/Chapter7/Futurework}         % What next?

\global\long\def\bibname{References}

\bibliographystyle{apalike}
\bibliography{thesis/Biblio/allcites}

\appendix
\include{thesis/Appendix/Derivations}
\include{thesis/Appendix/Proofs}
\end{document}
