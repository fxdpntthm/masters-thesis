...
\begin{figure}[h]
  \begin{framed}
    ...
    \end{minipage}
  \end{framed}
  \caption{Typing Rules for HM Type System}
  \label{fig:stlc-logic}
\end{figure}
The rules for type inference for Hindley-Milner (HM) type system are shown in \ref{fig:stlc-logic}. $\Gamma$ is the
...
\TODO{ This is kind of a big jump here.
