...
\begin{abstract}
  ...
  We build a prototype of a Curry-Howard interpretation of the logic of \BI\ [\cite{ohearn_bunched_2003}]---$\alpha\lambda$-calculus---
  by introducing 2 new type constructors of arrow type: sharing arrow ($\rightarrow$) and separating arrow($\sepimp$) to replace
  ...
  We base our work on Quill [\cite{morris_best_2016}] that has a notion of unrestricted types.
  ...
  duplicated or dropped anytime without any adverse implications and all existing programs typecheck.
