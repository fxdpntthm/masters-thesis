...
\include{Chapter2/Examples}           % file handles, doubly linked list, circular linked list as a queue
\include{Chapter3/Typechecking}       % Core syntax and Types with modified Algorithm M and unification
\include{Chapter4/Datastructure}      % sharing pair and weakening example Monad etc
\include{Chapter5/Futurework}
