...
\begin{abstract}
  ...
  based on the logic of bunched implications (\BI) \citep{ohearn_bunched_2003}. We introduce two kinds of program objects---restricted
  and unrestricted---and two kinds of function implications---sharing and separating.
  The restricted objects model resources while the unrestricted objects model program objects that do not contain any resources.
