...
% The type variable $t$ in both [$\sepimp$I$^s$] and [$\shimp$I$^s$] are new.
...
that $\Gamma \circledast \Delta$ is indeed true. Similarly, $\Gamma \tightoverset{\thicksim}{\varoplus} \Delta$ means that $\Gamma \varoplus \Delta$ is well
defined.
